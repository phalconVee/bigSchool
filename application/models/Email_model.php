...
class Email_model extends CI_Model {
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
        ...
        $config['smtp_user']        = 'fd8370401c7eca';
        $config['smtp_pass']        = 'd881b40cc9e55a';
        ...
        $school = $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;
		...
		$msg = $msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"#\">&copy; 2017 ".$school."</a></center>";

...
class Admin extends CI_Controller
{
    ...
    /*function bar_graph()
    {
        ...
        $data = array();
        $result = $this->crud_model->get_attendance_chart();
    ...
    function scratch_cards($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('cards_generated_successfully'));
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('card_deleted'));
            redirect(base_url() . 'index.php?admin/scratch_cards/', 'refresh');
        }

        if ($param1 == 'delete_all') {
            $this->db->empty_table('cards');
            $this->session->set_flashdata('flash_message' , get_phrase('scratched_cards_removed'));
            redirect(base_url() . 'index.php?admin/scratch_cards/', 'refresh');
        }
    ...
    function bulk_sms($param1 = '')
    {
        ...
        if($param1 == 'send_bulk_sms') {
            ...
            $sender   = $this->db->get_where('settings', array('type' => 'system_title'))->row()->description;
            ...
            $result = $this->ebulk_sms->useJSON($json_url, $username, $apikey, $flash, $sendername, $message, $recipients);

		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                      <?php if($row2['due'] != 0 ){?>
                         <a href="<?php echo base_url('index.php?parents/pay_with_paystack/'.$row['student_id'].'/'.$row2['invoice_id']);?>" type="button" class="btn btn-info"> <?php echo get_phrase('pay_with_paystack') ?></a>
                      <?php } else{ ?>
                         <button type="button" class="btn btn-default"><?php echo get_phrase('no dues to pay') ?></button>
                      <?php } ?>
                  </div>

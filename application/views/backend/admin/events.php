...
<?php include 'left_sidebar.php'; ?>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                        <!-- EDITING LINK -->
                        <li>
                            <a href="#" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_edit_event/<?php echo $row['event_id']; ?>');">
                        ...
                        <!-- DELETION LINK -->
                        <li>
                            <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>index.php?admin/frontend_events/delete/<?php echo $row['event_id']; ?>');">
    ...
    <div class="tab-pane" id="tab2">
        ...
        <form class="form-horizontal form-groups" method="post" action="<?=base_url()?>index.php?admin/frontend_events/add_event" style="margin-top: 20px;">

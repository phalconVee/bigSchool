...
class Crud_model extends CI_Model {
    ...
    function getStatus() {
        ...
        $query = $this->db->query("SELECT status FROM attendance ORDER BY FROM_UNIXTIME(UNIX_TIMESTAMP(timestamp), '%M')");
        return $query->result();
    }

    function getMonth(){
        $query = $this->db->query("SELECT DISTINCT timestamp FROM attendance ORDER BY FROM_UNIXTIME(UNIX_TIMESTAMP(timestamp), '%M')");
        return $query->result();
    }
